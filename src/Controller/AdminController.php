...
class AdminController extends AbstractController
{
    ...
    public function index(Request $request, EntityManagerInterface $entityManagerInterface, UserPasswordHasherInterface $passwordHasher): Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Sauvegarder le mot de passe : '.$plainPassword);
        }
        ...
        // //fourthItem (Habitats)
        // $habitats = $entityManagerInterface->getRepository(Habitats::class)->findAll();
        // $newHabitat = new Habitats();
    ...
    public function delete(string $title, EntityManagerInterface $entityManagerInterface): Response
    {
        ...
        $deleteService2 = $entityManagerInterface->getRepository(Habitats::class)->findOneBy(['name' => $title]);
